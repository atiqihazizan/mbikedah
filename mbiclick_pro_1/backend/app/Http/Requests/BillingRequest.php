...
class BillingRequest extends FormRequest
{
	...
	public function messages(): array
	{
		return [
			...
			'no_project.max' => 'Nombor projek terlalu panjang',
			...
			'total_amount.min' => 'Jumlah terlalu rendah',
			...
			'details.required' => 'Sila masukkan butiran',
			'details.min' => 'Sila masukkan sekurang-kurangnya satu butiran',
			'details.*.description.required' => 'Sila masukkan keterangan',
			'details.*.description.max' => 'Keterangan item terlalu panjang',
			'details.*.budget_code.required' => 'Sila masukkan kod bajet',
			'details.*.budget_id.required' => 'Sila pilih bajet',
			'details.*.budget_id.exists' => 'Bajet yang dipilih tidak sah',
			'details.*.price.required' => 'Sila masukkan harga',
			'details.*.price.min' => 'Harga diperlukan',
			'details.*.quantity.required' => 'Sila masukkan kuantiti',
			'details.*.quantity.min' => 'Kuantiti diperlukan',
			// 'details.*.purpose.required' => 'Sila masukkan tujuan',
			// 'details.*.purpose.max' => 'Tujuan item terlalu panjang',
			// 'details.*.unit.required' => 'Sila masukkan unit'
