...
@section('toolbar')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Kemaskini Pengumuman</h1>
...
@section('container')
    <div class="card">
        <div class="card-body container">
            <form action="/cms/event/{{ $data->id }}" method="post" autocomplete="off">
                @csrf
                @method('put')
