    ...
    <div class="app-toolbar align-items-center justify-content-between py-2 py-lg-4">
        <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
            <div class="d-flex flex-column align-items-start me-3 gap-2">
                <h1 class="d-flex text-dark fw-bolder m-0 fs-3">Lejer Bajet</h1>
            </div>
            @if($errors->any())
            ...
            <div class="modal-content">
                ...
                <form action="/budget/budgetledger/" method="post" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <div class="row mb-5">
                            <div class="col-md-9">
                                <label class="required fs-6 fw-bold mb-2">Item Bajet</label>
...
<script>
    ...
    function showladger(ym){
        yrmth = ym
        $.get(APP_URL + './budget/ledger/'+ym,function(res){
            if(res.success){
                tbody.innerHTML = res.data.map(function(r,n){
                    ...
                    <tr>
                        ...
                        <td class="">${r.bcode + ' - ' + r.bname}</td>
                        <td>${ r.remark==null?'':r.remark }</td>
                        <td class="text-end">${currency(r.amt)}</td>
                    </tr>
                    `
                    /*<td class="text-end d-none">
                      <a href="#" class="btn btn-sm p-0" onclick="deleteLedger('${r.id}')"><i class="fa fa-trash fs-3 text-danger"></i></a>
                    </td>*/
                }).join('')
            } else {
                tbody.innerHTML = '';
