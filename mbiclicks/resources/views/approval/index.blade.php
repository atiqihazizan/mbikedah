...
{{--        <button type="button" class="btn btn-primary" onclick="KTPending.main.redraw()">Reload Data</button>--}}
    </div>
@endsection
@section('body')
    <div class="card frapage min-h-100" id="kt-table-petition">
        ...
        {{--<div class="card-body fs-6 py-15 px-10 text-gray-700 py-lg-15 px-lg-15">--}}
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed gy-5" id="kt_table_pending">
                ...
                <tr class="text-start fw-bold fs-5 text-uppercase gs-0">
                    {{--<th class="w-80px text-center">Tarikh</th>--}}
                    <th class="w-100px">Jenis</th>
                    <th class="w-auto">Perkara</th>
                    <th class="w-250px">Jabatan</th>
                    <th class="w-125px text-center">Untuk Perhatian</th>
...
@push('javascript')
    <script src="{{ URL::asset('js/app/activity.js?v='.time()) }}"></script>
@endpush
