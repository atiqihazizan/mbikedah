<div class="modal fade" tabindex="-1" id="kt_modal_bookcar" style="background-color: #0101016b">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Penggunaan Kenderaan Pejabat</h3>
            ...
            <div class="modal-body">
                <form id="form_book_car" autocomplete="off">
                    @csrf
                    ...
                    <div class="fv-row mb-5"><label class="form-label mb-2">Kenderaan</label><select class="form-select" aria-label="Book Car" name="refid"></select></div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="save_booking_car" >Save changes</button>
            </div>
        </div>
    </div>
</div>
